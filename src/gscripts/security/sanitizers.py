...
class InputSanitizer:
    ...
    @staticmethod
    def sanitize_json_data(data: Any, max_depth: int = 10, 
        ...
        def _sanitize_recursive(obj, current_depth=0):
            ...
            if isinstance(obj, dict):
                ...
                for key, value in obj.items():
                    ...
                    if clean_key:
                        sanitized[clean_key] = _sanitize_recursive(value, current_depth + 1)
                        item_count += 1
    ...
    def sanitize_config_value(value: Any, value_type: str = 'string') -> Any:
        ...
        if value_type == 'string':
            ...
            if isinstance(value, list):
                return [InputSanitizer.sanitize_string(str(item)) for item in value[:100]]
            return [InputSanitizer.sanitize_string(str(value))]
