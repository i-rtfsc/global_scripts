...
from typing import List, Callable, Any, Optional, Dict, Union, Type
...
def validate_args(min_args: int = None, max_args: int = None, required_devices: bool = False):
    """
    参数验证装饰器
    ...
    def decorator(func):
        ...
        async def wrapper(*args, **kwargs):
            try:
                ...
                from ..core.config_manager import CommandResult
                error_msg = default_error_message or f"执行 {func.__name__} 时发生错误: {str(e)}"
